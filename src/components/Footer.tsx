          ...
          <div>
            <div className="flex items-center gap-3 mb-4 group cursor-pointer">
              <img 
                src={logo} 
                alt="Spaark Logo" 
                className="h-16 w-16 sm:h-20 sm:w-20 object-contain filter drop-shadow-[0_0_12px_rgba(236,72,153,0.4)] transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_20px_rgba(236,72,153,0.6)]" 
              />
